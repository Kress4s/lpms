...
const docTemplate_swagger = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/v1/implement/gov/list/count": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "ImplementGovCountFilter",
                        "name": "parameters",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/vo.ImplementGovCountFilter"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/vo.StatusCountResp"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/inspect/reserve/early-plan/list": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "ReserveInspectParam",
                        "name": "parameters",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/vo.ReserveInspectParam"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "查询储备库前期计划项目列表成功",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/vo.DataPagination"
        ...
        "/api/v1/inspect/reserve/out-storage/list": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/inspect/reserve/{id}/early-plan/pass": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/inspect/reserve/{id}/out-storage/pass": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/inspect/reserve/{id}/refuse": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "vo.ImplementGovCountFilter": {
            ...
            "properties": {
                ...
                "plan_begin": {
                    "description": "计划开工开始时间",
                    "type": "string"
                },
                "plan_end": {
                    "description": "计划开工结束时间",
                    "type": "string"
                },
                "point_type": {
                    "description": "标签 0:省重点实施项目,1:省重点预备项目,2:省重大产业项目;3:省4+1项目;4:省6千亿项目;5:市重点实施项目;6:市重点预备项目;7:无重点类型;8: 152工程",
        ...
        "vo.ImplementGovFilterParam": {
            ...
            "properties": {
                ...
                "cur_year_all_begin": {
                    "description": "当年 起始时间(闭区间) eg: 2022-01-01 00:00:00",
                    "type": "string"
                },
                "cur_year_all_end": {
        ...
        "vo.StatusCountResp": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "状态：-2：当年全部，-1：当年竣工，0：未开工，2：开工建设，4:竣工库",
                    "type": "integer"
                }
            }
        },
