...
type ImpleIndustryFilterParam struct {
	//项目名称
...
func (r *ImpleIndustryReq) ToModel(openID string) *models.ImpleIndustry {
	return &models.ImpleIndustry{
		Level:                   r.Level,
		Name:                    r.Name,
...
func NewImpleIndustryResponse(r *models.ImpleIndustry) (*ImpleIndustryResp, error) {
	return &ImpleIndustryResp{
		Level:                   r.Level,
		Name:                    r.Name,
		ConstructSubject:        r.ConstructSubject,
		ConstructSite:           r.ConstructSite,
...
type ListImpleIndustryResp struct {
	// id
	ID int64 `json:"id"`
	// 名称
	Name string `json:"name"`
